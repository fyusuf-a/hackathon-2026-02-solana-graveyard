...
pub mod graveyard_hackathon {
    ...
    pub fn create_auction(ctx: Context<CreateAuction>, _seed: u64, start_time: i64, deadline: i64, min_price: u64, min_increment: u64, referral_structure: Option<ReferralStructure>) -> Result<()> {
        ctx.accounts.create(start_time, deadline, min_price, min_increment, referral_structure, &ctx.bumps)
    }
